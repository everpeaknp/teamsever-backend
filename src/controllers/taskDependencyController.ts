...
// @access  Private
const createDependency = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
...
// @access  Private
const deleteDependency = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { id } = req.params;
...
// @access  Private
const getTaskDependencies = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
...
// @access  Private
const getBlockingTasks = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  const { taskId } = req.params;
