 ...
 */
const getWorkspacePresence = asyncHandler(async (req: any, res: any) => {
 ...
 */
const getOnlineUsers = asyncHandler(async (req: any, res: any) => {
  const { workspaceId } = req.params;
  const userId = req.user.id;
 ...
 */
const getUserPresence = asyncHandler(async (req: any, res: any) => {
