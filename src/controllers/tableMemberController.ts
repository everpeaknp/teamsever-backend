...
const getTableMembers = asyncHandler(async (req: any, res: any, next: any) => {
  ...
  const members = workspace.members
    ...
    .map((member: any) => {
      const override = tableMembers.find((tm: any) => tm.user._id.toString() === member.user._id.toString());
 ...
 */
const addTableMember = asyncHandler(async (req: any, res: any, next: any) => {
  const { tableId } = req.params;
 ...
 * @access  Private (Admin or Owner)
 */
const updateTableMember = asyncHandler(async (req: any, res: any, next: any) => {
 ...
 * @access  Private (Admin or Owner)
 */
const removeTableMember = asyncHandler(async (req: any, res: any, next: any) => {
  const { tableId, userId } = req.params;
  const currentUserId = req.user.id;
