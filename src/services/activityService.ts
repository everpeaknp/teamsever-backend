...
class ActivityService {
  ...
  async getActivities(params: {
    userId?: string; // Optional userId for permission checks (not used for filter)
    performedBy?: string; // Filter by user who performed the action
    workspaceId?: string;
    spaceId?: string;
    listId?: string;
    limit?: number;
    ...
    if (performedBy) query.user = performedBy;
