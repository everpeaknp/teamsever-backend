...
// @access  Private
const addManualTime = asyncHandler(async (req, res, next) => {
...
// @access  Private
const getTaskTimeSummary = asyncHandler(async (req, res, next) => {
    const { taskId } = req.params;
...
// @access  Private
const getProjectTimeSummary = asyncHandler(async (req, res, next) => {
...
// @access  Private
const getRunningTimer = asyncHandler(async (req, res, next) => {
...
// @access  Private
const deleteTimeEntry = asyncHandler(async (req, res, next) => {
    const { entryId } = req.params;
