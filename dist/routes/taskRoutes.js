...
const { createTask, getListTasks, getTask, updateTask, deleteTask, createSubtask, getSubtasks, addDependency, removeDependency, getDependencies, getDependents } = require("../controllers/taskController");
const { protect } = require("../middlewares/authMiddleware");
const { checkTaskLimit } = require("../middlewares/subscriptionMiddleware");
const { requirePermission } = require("../permissions/permission.middleware");
const validate = require("../utils/validation");
const { createTaskSchema, updateTaskSchema, createSubtaskSchema, addDependencySchema } = require("../validators/taskValidators");
// List-scoped router
