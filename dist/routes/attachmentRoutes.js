 ...
 */
router.post("/tasks/:taskId/attachments/init-upload", protect, attachmentController.initializeUpload);
/**
 * @swagger
 ...
 *         description: Task not found
 */
router.post("/tasks/:taskId/attachments/confirm", protect, attachmentController.confirmUpload);
/**
 * @swagger
 ...
 *         description: Task not found
 */
router.get("/tasks/:taskId/attachments", protect, attachmentController.getTaskAttachments);
/**
 * @swagger
 ...
 */
router.delete("/attachments/:attachmentId", protect, attachmentController.deleteAttachment);
