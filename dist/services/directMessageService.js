    ...
    async sendMessage(data) {
        ...
        try {
            await logger.logActivity({
                userId: senderId,
                workspaceId: null, // DMs are not workspace-specific
                action: "CREATE",
        ...
        try {
            await enhancedNotificationService.notifyDirectMessage(conversation._id.toString(), senderId, targetUserId, content);
        }
        catch (error) {
